...
// 下面按照上面两个成员dom操作  对进度时间规划的任务也类似这样操作
		$("#task_add").click(function(){
			var new_task = "<div class=\"row task_is_time\" style=\"display: none;margin-top: 15px\"><label for=\"lastname\" class=\"col-sm-2 col-md-2 col-xs-12 control-label\">阶段任务</label><div class=\"col-md-2 col-sm-2 col-xs-3\"><div class=\"input-group date task_date\" data-date=\"\" data-date-format=\"yyyy-mm-dd\" data-link-field=\"dtp_input2\" data-link-format=\"yyyy-mm-dd\"><input class=\"form-control task_is_empty  task_is_stime\" size=\"16\" type=\"text\" value=\"\" placeholder=\"请选择时间\" readonly><span class=\"input-group-addon\"><span class=\"glyphicon glyphicon-calendar text-primary\"></span></span></div></div><div class=\"col-md-2 col-sm-2 col-xs-3\"><div class=\"input-group date task_date\" data-date=\"\" data-date-format=\"yyyy-mm-dd\" data-link-field=\"dtp_input2\" data-link-format=\"yyyy-mm-dd\"><input class=\"form-control task_is_empty  task_is_etime\" size=\"16\" type=\"text\" value=\"\" placeholder=\"请选择时间\" readonly><span class=\"input-group-addon\"><span class=\"glyphicon glyphicon-calendar text-primary\"></span></span></div><input type=\"hidden\" id=\"dtp_input2\" value=\"\" /></div><div class=\"col-md-4 col-sm-4 col-xs-4\"><div class=\"input-group\"><input type=\"text\" class=\"form-control task_is_empty\" id=\"lastname\" placeholder=\"需完成任务\"><div class=\"input-group-addon\"><span class=\"glyphicon glyphicon-tasks text-primary\"></span></div> </div></div><div class=\"col-md-2 col-sm-2 col-xs-2\"><button type=\"button\" class=\"btn btn-danger task_sub\"style=\"float: right\"><span class=\"glyphicon glyphicon-minus\" aria-hidden=\"true\"></span></button></div></div>";
